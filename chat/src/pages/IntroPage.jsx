    ...
    <div className="min-h-dvh bg-[#0b0f16] text-white">
      ...
      <div
        ...
        className="
                  ...
                  bg-[radial-gradient(120%_120%_at_0%_100%,rgba(236,72,153,0.28)_0%,transparent_55%)]
                  "
      />
      <div
        aria-hidden
        className="
                  pointer-events-none fixed inset-0
                  bg-[radial-gradient(120%_120%_at_100%_0%,rgba(124,58,237,0.15)_0%,transparent_55%)]
                  "
      />
        ...
        <div className="max-w-screen-2xl mx-auto px-5 sm:px-8 pb-10">
          <div
            className="
                      ...
                      rounded-3xl border border-white/10 bg-[#0f1218]/90 backdrop-blur
          ...
          >
            ...
            <motion.div
              ...
              className="
                        relative p-8 sm:p-12 lg:p-16 pl-12
                        bg-[radial-gradient(80%_70%_at_0%_100%,rgba(236,72,153,0.6)_0%,rgba(236,72,153,0.15)_35%,transparent_70%)]
                        "
            >
              {/* Tiêu đề + mô tả */}
              ...
              <button
                ...
                className="
                          ...
                          bg-pink-500 hover:bg-pink-600 text-white font-semibold text-xl
                          rounded-xl px-8 py-3 shadow-[0_8px_24px_-8px_rgba(236,72,153,0.7)]
                          transition
                          "
              >
                Bắt đầu
            ...
            <div
              aria-hidden
              className="pointer-events-none absolute inset-x-8 -bottom-6 h-10 rounded-full
